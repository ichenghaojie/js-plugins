...
dragList.prototype.drag=function(obj){
	...
	obj.onmousedown = function(event){
        ...
        oThis.oUl.insertBefore(borderBox, obj);
        borderBox.style.left = obj.offsetLeft + 'px';
        borderBox.style.top =obj.offsetTop + 'px';
		document.onmousemove = function(event){
            ...
            if(oNear){
				...
				oNear.index = temp;
                oThis.doMove(borderBox, oThis.pos[obj.index]);
...
dragList.prototype.doMove=function(obj, position){
	...
	obj.timer = setInterval(function(){
	    ...
	    var speedL = (position.left - nowL)/2;
	    var speedT = (position.top - nowT)/2;
