...
imgZoom.prototype.initialize=function(oImg,oSrc){
    var oThis=this;
    this.oBox = oImg;
    ...
    this.zoomIn.value="放大";
    this.zoomIn.innerHTML="放大";

    this.zoomOut=document.createElement('button');
    this.zoomOut.className="zoomOut";
    this.zoomOut.value="缩小";
    this.zoomOut.innerHTML="缩小";

    this.zoomOrg=document.createElement('button');
    this.zoomOrg.className="zoomOrg";
    this.zoomOrg.value="还原";
    this.zoomOrg.innerHTML="还原";

    this.oBox.appendChild(this.zoomIn);
    this.oBox.appendChild(this.zoomOut);
    this.oBox.appendChild(this.zoomOrg);
